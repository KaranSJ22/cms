...
export const STATUS_META = {
  A:   { label: 'Active',      colors: { bg: 'rgba(22,163,74,0.10)',   text: '#16a34a', border: 'rgba(22,163,74,0.25)'   } },
  D:   { label: 'Deactivated', colors: { bg: 'rgba(220,38,38,0.09)',   text: '#dc2626', border: 'rgba(220,38,38,0.2)'    } },
...
export const BOOKING_STATUS_META = {
  CR:  { label: 'Confirmed', bg: 'rgba(30,58,138,0.10)',  text: '#1e3a8a', border: 'rgba(30,58,138,0.22)',  dot: '#1e3a8a' },
...
export const DAY_SLOTS = [
  { code: 'BREAKFAST', label: 'Breakfast', icon: '🌅', time: '07:00 – 09:30', color: '#ea580c' },
  { code: 'LUNCH',     label: 'Lunch',     icon: '☀️', time: '12:00 – 14:30', color: '#2563eb' },
  { code: 'SNACKS',    label: 'Snacks',    icon: '🫖', time: '16:00 – 17:30', color: '#7c3aed' },
  { code: 'DINNER',    label: 'Dinner',    icon: '🌙', time: '19:00 – 21:00', color: '#0f766e' },
]
...
// SYSTEMROLES:  ADMIN
// CANTEENROLES: CTNMNG (manager), CTNAST (assistant), CTNSTF (staff/kiosk)
export const ROLE_META = {
  ADMIN:  { label: 'Administrator' },
  CTNMNG: { label: 'Canteen Manager' },
  CTNAST: { label: 'Canteen Assistant' },
  CTNSTF: { label: 'Canteen Staff' },
  CTNMGR: { label: 'Canteen Manager (sys)' },  // wallet-level role code
}
