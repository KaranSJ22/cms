...
export function MenuForm({ initialData, onSubmit, onCancel, isSubmitting }) {
  ...
  const handleSubmit = (e) => {
    ...
    payload.ISSPECIAL = Number(formData.ISSPECIAL || 0);
    payload.OFFSER = Number(formData.OFFSER || 0);
                ...
                <div className="space-y-3 pt-2 sm:pt-4">
                  ...
                  <div className="flex items-start gap-2">
                    <input
                      ...
                      id="OFFSER"
                      name="OFFSER"
                      checked={formData.OFFSER === 1}
                      onChange={handleChange}
                      className="w-4 h-4 mt-0.5 text-orange-500 border-slate-300 rounded focus:ring-orange-500 cursor-pointer"
                    />
                    <div>
                      <label htmlFor="OFFSER" className="text-sm font-medium text-slate-700 cursor-pointer flex items-center gap-1.5">
                        <span>Available for Official Catering</span>
                      ...
                      <p className="text-[0.65rem] text-slate-400">
                        Enables this item to be selected when configuring Official Services & Combos.
                      </p>
                    </div>
                  </div>
                </div>
