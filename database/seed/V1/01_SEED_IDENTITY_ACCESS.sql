...
(1, 'VSSCCEN',    'HSFC Central Canteen',  'Main Campus, Building A'),
(1, 'SACBLK5',    'HSFC Block 5 Canteen',   'Block 5, Ground Floor');
...
('ADMIN01',     'System Admin',       'admin.cms@isro.gov.in',          '9000000001', '$2b$10$wmIKO3mYBqU92mHOkt72VuRosFu8kbySQ/PykEM2ZnRX3QOgvk3Vq', 'LOCAL'),
('EMP1001',     'Ravi Kumar',         'ravi.kumar@isro.gov.in',         '9000000002', '$2b$10$wmIKO3mYBqU92mHOkt72VuRosFu8kbySQ/PykEM2ZnRX3QOgvk3Vq', 'LOCAL'),
('CON2001',     'Suresh B',           'suresh.vendor@example.com',      '9000000003', '$2b$10$wmIKO3mYBqU92mHOkt72VuRosFu8kbySQ/PykEM2ZnRX3QOgvk3Vq', 'LOCAL'),
('OCEVSSC01',   'Anil Nair',          'anil.nair@vssc.gov.in',          '9000000004', '$2b$10$wmIKO3mYBqU92mHOkt72VuRosFu8kbySQ/PykEM2ZnRX3QOgvk3Vq', 'LOCAL'),
('CAN001',      'Mahesh Staff',       'mahesh.canteen@example.com',     '9000000005', '$2b$10$wmIKO3mYBqU92mHOkt72VuRosFu8kbySQ/PykEM2ZnRX3QOgvk3Vq', 'LOCAL'),
('FOC001',      'Front Office User',  'frontoffice@isro.gov.in',        '9000000006', '$2b$10$wmIKO3mYBqU92mHOkt72VuRosFu8kbySQ/PykEM2ZnRX3QOgvk3Vq', 'LOCAL'),
('STF001',      'Priya Kitchen',      'priya.kitchen@example.com',      '9000000007', '$2b$10$wmIKO3mYBqU92mHOkt72VuRosFu8kbySQ/PykEM2ZnRX3QOgvk3Vq', 'LOCAL');


/* ---- CMS_ROLE (4 roles) ---- */
-- ROLEID: 1=ADMIN, 2=CTNMNG, 3=CTNSTF, 4=FRONTOFF
...
('CTNMNG',  'Canteen Manager',      'Approve menus, manage canteen operations'),
('CTNAST',  'Canteen Assistant',      'Approve menus, manage canteen operations'),
('CTNSTF',  'Canteen Staff',        'Add menu items, manage day-to-day canteen operations'),
...
(5, 2, 1,    CURRENT_TIMESTAMP),   -- Mahesh gets CTNMNG (system-wide)
(7, 3, 1,    CURRENT_TIMESTAMP),   -- Priya gets CTNSTF (system-wide)
...
(5, 2, 1, 1, CURRENT_TIMESTAMP, 1),   -- Mahesh is CTNMNG at HSFC Main (default canteen)
(5, 2, 2, 0, CURRENT_TIMESTAMP, 1),   -- Mahesh is also CTNMNG at HSFC Annexe
(7, 3, 1, 1, CURRENT_TIMESTAMP, 1),   -- Priya is CTNSTF at HSFC Main (default)
(7, 3, 2, 0, CURRENT_TIMESTAMP, 1);   -- Priya is also CTNSTF at HSFC Annexe
...
(2,    'PRM',   'Ravi Kumar',                  'A', CURRENT_TIMESTAMP),
(3,    'CNT',    'Suresh B - ABC Facility',     'A', CURRENT_TIMESTAMP),
(4,    'OCE', 'Anil Nair - VSSC',            'A', CURRENT_TIMESTAMP),
(5,    'CNT',    'Mahesh Staff - Canteen Vendor','A', CURRENT_TIMESTAMP),
(NULL, 'VIS',     'Arun Sharma',                 'A', CURRENT_TIMESTAMP),
(NULL, 'VIS',     'Preeti Verma',                'A', CURRENT_TIMESTAMP);
...
INSERT INTO CMS_USER (LOGINID, FULLNAME, EMAIL, MOBILENO, PWDHASH, AUTHPROV) VALUES
('EMP1002', 'Deepa Sharma',  'deepa.sharma@isro.gov.in',  '9000000009', '$2b$10$wmIKO3mYBqU92mHOkt72VuRosFu8kbySQ/PykEM2ZnRX3QOgvk3Vq', 'LOCAL'),
('EMP1003', 'Karthik R',     'karthik.r@isro.gov.in',     '9000000010', '$2b$10$wmIKO3mYBqU92mHOkt72VuRosFu8kbySQ/PykEM2ZnRX3QOgvk3Vq', 'LOCAL'),
('EMP1004', 'Meena Nair',    'meena.nair@isro.gov.in',    '9000000011', '$2b$10$wmIKO3mYBqU92mHOkt72VuRosFu8kbySQ/PykEM2ZnRX3QOgvk3Vq', 'LOCAL');

INSERT INTO CMS_CUSTOMER (USERID, CTYPECODE, DISPNAME, STATUS, VALIDFROM) VALUES
(9,  'PRM', 'Deepa Sharma',  'A', CURRENT_TIMESTAMP),
(10, 'PRM', 'Karthik R',     'A', CURRENT_TIMESTAMP),
(11, 'PRM', 'Meena Nair',    'A', CURRENT_TIMESTAMP);
...
INSERT INTO CMS_USER (LOGINID, FULLNAME, EMAIL, MOBILENO, PWDHASH, AUTHPROV) VALUES
('CON2002', 'Ramesh G',     'ramesh.g@vendor.com',    '9000000012', '$2b$10$wmIKO3mYBqU92mHOkt72VuRosFu8kbySQ/PykEM2ZnRX3QOgvk3Vq', 'LOCAL'),
('CON2003', 'Lakshmi P',    'lakshmi.p@vendor.com',   '9000000013', '$2b$10$wmIKO3mYBqU92mHOkt72VuRosFu8kbySQ/PykEM2ZnRX3QOgvk3Vq', 'LOCAL');

INSERT INTO CMS_CUSTOMER (USERID, CTYPECODE, DISPNAME, STATUS, VALIDFROM) VALUES
(12, 'CNT', 'Ramesh G - DEF Services',    'A', CURRENT_TIMESTAMP),
(13, 'CNT', 'Lakshmi P - GHI Catering',   'A', CURRENT_TIMESTAMP);
...
INSERT INTO CMS_USER (LOGINID, FULLNAME, EMAIL, MOBILENO, PWDHASH, AUTHPROV) VALUES
('OCESAC01', 'Vikram Patel',   'vikram.patel@sac.gov.in',   '9000000014', '$2b$10$wmIKO3mYBqU92mHOkt72VuRosFu8kbySQ/PykEM2ZnRX3QOgvk3Vq', 'LOCAL'),
('OCEISAC01','Sunita Rao',     'sunita.rao@isac.gov.in',    '9000000015', '$2b$10$wmIKO3mYBqU92mHOkt72VuRosFu8kbySQ/PykEM2ZnRX3QOgvk3Vq', 'LOCAL'),
('OCEVSSC02','Mohan Das',      'mohan.das@vssc.gov.in',     '9000000016', '$2b$10$wmIKO3mYBqU92mHOkt72VuRosFu8kbySQ/PykEM2ZnRX3QOgvk3Vq', 'LOCAL');

INSERT INTO CMS_CUSTOMER (USERID, CTYPECODE, DISPNAME, STATUS, VALIDFROM) VALUES
(14, 'OCE', 'Vikram Patel - SAC',   'A', CURRENT_TIMESTAMP),
(15, 'OCE', 'Sunita Rao - ISAC',    'A', CURRENT_TIMESTAMP),
(16, 'OCE', 'Mohan Das - VSSC',     'A', CURRENT_TIMESTAMP);
...
(NULL, 'VIS', 'Ganesh Iyer',      'A', CURRENT_TIMESTAMP, DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 2 DAY)),
(NULL, 'VIS', 'Shalini Mehta',    'A', CURRENT_TIMESTAMP, DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 1 DAY));
...
(3, 'Level 3 — Committee Approval',        1, 'Third approval by system administrator'),
(4, 'Level 4 — Director Approval',         1, 'Final approval by system administrator');
...
-- CTNMNG can manage menu operations
...
-- CTNSTF can prepare daily menus
