...
| `/auth/sso`   | POST   | No   | Authenticates user via SSO               |
...
| Endpoint                 | Method | Auth | Description                  |
| ------------------------ | ------ | ---- | ---------------------------- |
| `/common/status`         | GET    | Yes  | List all system statuses     |
| `/common/customer-types` | GET    | Yes  | List all customer types      |
| `/common/screens`        | GET    | Yes  | List all screens             |
| `/common/autonos`        | GET    | Yes  | List auto numbers            |
...
| `/identity/user-roles`      | POST   | Yes  | Assign role (`CMSASSIGNROL`)   |
...
| Endpoint                                       | Method | Auth | Description                                         |
|------------------------------------------------|--------|------|-----------------------------------------------------|
| `/wallets`                                     | POST   | Yes  | Create new wallet (`CMSADDWALLET`)                 |
| `/wallets/topup`                               | POST   | Yes  | Top up wallet balance (`CMSADDWALLETAMT`)          |
| `/wallets/customer/:customerId`                | GET    | Yes  | Get wallet details (`CMSGETWALLET`)                |
| `/wallets/customer/:customerId/transactions`   | GET    | Yes  | List wallet transactions (`CMSLISTWALLETTRAN`)     |
| `/wallets/withdraw/request`                    | POST   | Yes  | Request withdrawal (`CMSREQWALLETWD`)              |
| `/wallets/withdraw/:walletWdId/approve`        | POST   | Yes  | Approve withdrawal (`CMSAPPWALLETWD`)              |
| `/wallets/withdraw/:walletWdId/reject`         | POST   | Yes  | Reject withdrawal (`CMSREJWALLETWD`)               |
| `/wallets/withdraw/requests`                   | GET    | Yes  | List withdrawal requests (`CMSLISTWALLETWD`)       |
