...
#### 10.10.8 Serve Booking Item
* **Endpoint**: `/bookings/:id/items/:itemId/serve`
* **HTTP Method**: `PATCH`
* **Description**: Serve a specific item within a booking.
* **Authentication Required**: Yes
* **Required Roles**: `CTNMNG`, `CTNSTF`
* **Path Parameters**:
  * `id` (integer, positive)
...
{
  "SUCCESS": true,
  "MESSAGE": "Booking item served successfully",
  "DATA": { "affectedRows": 1 }
}
```

#### 10.10.9 Scan RFID
* **Endpoint**: `/bookings/scan-rfid`
* **HTTP Method**: `POST`
* **Description**: Scan an RFID card at a kiosk to mark a pre-booking as served or perform a kiosk booking.
* **Authentication Required**: Yes
* **Required Roles**: `CTNMNG`, `CTNSTF`
* **Request Body Example**:
```json
{
  "PRFIDHASH": "abcd1234efgh5678",
  "PSERVICEID": 2
}
```
* **Success Response Example**:
...
#### 10.11.2 Top Up Wallet
* **Endpoint**: `/wallets/topup`
* **HTTP Method**: `POST`
* **Description**: Top up an existing wallet balance.
* **Authentication Required**: Yes
* **Required Roles**: `ADMIN`, `CASHIER`
* **Request Body Example**:
```json
...
#### 10.11.3 Get Wallet Details
* **Endpoint**: `/wallets/customer/:customerId`
* **HTTP Method**: `GET`
* **Description**: Retrieve wallet balance and reserved amount.
* **Authentication Required**: Yes
* **Required Roles**: Valid authenticated user

#### 10.11.4 Get Wallet Transactions
* **Endpoint**: `/wallets/customer/:customerId/transactions`
* **HTTP Method**: `GET`
...
#### 10.11.5 Request Withdrawal
* **Endpoint**: `/wallets/withdraw/request`
* **HTTP Method**: `POST`
* **Description**: Customer requests a withdrawal of funds.
* **Authentication Required**: Yes
* **Request Body Example**:
```json
{
  "customerId": 12,
  "amount": 150,
  "remarks": "Refund needed"
}
```

#### 10.11.6 Approve Withdrawal
* **Endpoint**: `/wallets/withdraw/:walletWdId/approve`
* **HTTP Method**: `POST`
...
```json
{
  "paymentMethod": "CASH",
  "refNo": "OUT1234",
  "remarks": "Handed cash to user"
}
```

#### 10.11.7 Reject Withdrawal
* **Endpoint**: `/wallets/withdraw/:walletWdId/reject`
* **HTTP Method**: `POST`
...
#### 10.11.8 List Withdrawal Requests
* **Endpoint**: `/wallets/withdraw/requests`
* **HTTP Method**: `GET`
* **Description**: List withdrawal requests for admin review.
* **Query Parameters**:
  * `customerId` (integer, optional)
  * `status` (string, optional - REQ, COM, REJ, CAN)
* **Authentication Required**: Yes
* **Required Roles**: `ADMIN`, `CASHIER`
